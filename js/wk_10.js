...
//console.log(document.getElementById("my_head")) //other addEventsListener(double click, hover)
...
//    document.getElementById("image").src = "img/unicorn (1).png"
//})
...
document.getElementById("my_head").addEventListener("click", function(e){
    ...
    document.getElementById("paragraph").innerHTML = "this is the new text";
    document.getElementById("paragraph").style.color = "blue";
    document.getElementById("image").src = "img/IMG_5705.jpg";
})
